"""One-off driver: resolve + download SoftBank Group's latest annual report and SAVE the PDF.
Fully autonomous (no manual pin) to honestly test the resolver + fetch end-to-end."""
import sys
sys.stdout.reconfigure(encoding="utf-8")
import ir_resolve_proto as R
import ir_fetch_proto as F

NAME, TICKER, COUNTRY = "SoftBank Group Corp.", "9984", "Japan"
SAVE_PATH = "_ir_9984_SoftBank.pdf"
